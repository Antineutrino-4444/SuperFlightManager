...
const AIRCRAFT_TYPES = [
  ...
  // Sukhoi
  { code: 'SU9', manufacturer: 'Sukhoi', model: 'Superjet 100', family: 'Superjet', category: 'Regional', typicalSeats: 98 },
...
// Build aircraft families map: family name -> array of aircraft codes
const AIRCRAFT_FAMILIES = {};
for (const ac of AIRCRAFT_TYPES) {
  if (!AIRCRAFT_FAMILIES[ac.family]) {
    AIRCRAFT_FAMILIES[ac.family] = {
      family: ac.family,
  ...
  AIRCRAFT_FAMILIES[ac.family].codes.push(ac.code);
  AIRCRAFT_FAMILIES[ac.family].models.push(ac.model);
}
